...
class FoodItems with ChangeNotifier {
  List<FoodModel> _items = [
    ...
    FoodModel(
      ...
      availability: 10,
      description:
          'Contains 12 pieces of Chicken Wings with Sesame Seeds and Sweet Chili Sauce',
      imageUrl:
    ...
    FoodModel(
      ...
      availability: 10,
      description:
          'Fuji Sushi, Monsieur Sushi, Meat Ball Sushi, Kayangan Sushi - 5 pieces each. Serves three people',
    ...
    FoodModel(
      ...
      type: 'Special',
      availability: 10,
      description: '7 pieces of Muffin with mixed flavors',
      imageUrl:
